...
# very minorly adapted by Marisa Casillas 20 May 2019 ... then again for Windows in July 2019
...
form Dir acquisition
	...
	text indirectory /Users/marcas/Documents/GitHub/Yeli-NAD/stimuli/audio/02-homogenize/02-final/
	text relindirectory audio/02-homogenize/02-final/
	word soundname all_sylls_concatenated_recoverably
	integer tier 1
	text worddirectory /Users/marcas/Documents/GitHub/Yeli-NAD/stimuli/audio/03-make_all_words/00-word_lists/training/test/
	text relworddirectory audio/03-make_all_words/00-word_lists/training/
	text outdirectory /Users/marcas/Documents/GitHub/Yeli-NAD/stimuli/audio/03-make_all_words/01-raw_words/
	text reloutdirectory audio/03-make_all_words/01-raw_words/
endform

# make a list of all the word files
Create Strings as file list... wdfilelist 'worddirectory$'*.txt
...
for f from 1 to number_files
	...
	Read Strings from raw text file... 'relworddirectory$''curr_file$'
	nPhons = Get number of strings
	Read from file... 'relindirectory$''soundname$'.wav
	samp_freq = Get sampling frequency
	Read from file... 'relindirectory$''soundname$'.TextGrid
	...
	select newSound
	Write to WAV file... 'reloutdirectory$''currfilename$'.wav
