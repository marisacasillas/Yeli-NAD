...
form Equalize V interval durations
	comment Directory of sound and text grid files
	text sound_directory /Users/mctice/Documents/Academic/Git-Projects/Yeli-NAD/stimuli/audio/01-best_of_each/02-trimmed_and_nucleus_marked/
...
Create Strings as file list... wavlist 'sound_directory$'/*.wav
...
for i from 1 to number_files
	...
	orig_len_c = dur_c
	duration_scale_factor_c = c_duration/orig_len_c
	...
	orig_len_v = dur_v
	duration_scale_factor_v = v_duration/orig_len_v
